...
#'
#' @title Estimation of the overdispersion parameter for Negative Binomial non-negative matrix factorization. This function is copied from the package: https://github.com/MartaPelizzola/SigMoS/tree/master
#'
